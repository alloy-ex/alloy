defmodule Anvil.Provider.OpenRouter do
  @moduledoc """
  ...
  - `:app_name` - Your app name for OpenRouter attribution (default: "Anvil")
  - `:app_url` - Your app URL for OpenRouter attribution (default: "https://github.com/anvil-ex")
  ...
  def complete(messages, tool_defs, config) do
    ...
    headers = [
      ...
      {"http-referer", Map.get(config, :app_url, "https://github.com/anvil-ex")},
      {"x-title", Map.get(config, :app_name, "Anvil")}
    ]
