defmodule Alloy.Skill do
  @moduledoc """
  Reusable prompt templates discovered from `.alloy/skills/` directories.
  ...
  1. Global: `~/.alloy/skills/`
  2. Project: `.alloy/skills/`
  ...
  def discover(opts \\ []) do
    ...
    global_dir = Path.join(home, ".alloy/skills")
    project_dir = Path.join(project, ".alloy/skills")
