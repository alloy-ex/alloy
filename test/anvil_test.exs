defmodule AnvilTest do
  ...
  describe "Anvil.run/2 simple conversation" do
  ...
  describe "Anvil.run/2 with tools" do
    ...
    test "handles multi-turn tool usage" do
      ...
      assert {:ok, result} =
               Anvil.run("Uppercase foo and bar separately",
                 provider: {TestProvider, agent_pid: pid},
                 tools: [UpperTool]
               )
  ...
  describe "Anvil.run/2 with conversation history" do
  ...
  describe "Anvil.run/2 error handling" do
  ...
  describe "Anvil.run/2 with middleware" do
  ...
  describe "Anvil.run/2 usage tracking" do
